...
/* Donation modal and Stripe checkout handoff */
let closeDonationModal = () => {};
...
(() => {
  ...
  closeDonationModal = function closeReaderDonationDesk() {
    const backdrop = document.getElementById("modalBackdrop");
    modal.classList.remove("open");
    modal.setAttribute("aria-hidden", "true");
...
registerReaderAccountRefresh(updateAuthUI);
